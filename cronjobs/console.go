...
import (
	...
	utils_ctl "github.com/Sam12121/toaetest/toae_utils/controls"
	"github.com/Sam12121/toaetest/toae_utils/log"
	ctl "github.com/Sam12121/toaetest/toae_worker/controls"
	"github.com/hibiken/asynq"
)

const (
	ConsoleAgentId     = "toae-console-cron"
...
func init() {
	numWorkloadStr := os.Getenv("TOAE_MAX_SCAN_WORKLOAD")
